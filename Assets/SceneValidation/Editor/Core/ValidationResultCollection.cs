...
public sealed class ValidationResultCollection {
	...
	public void AddResult(ValidationSeverity severity, string ruleId, string ruleName, string message, string details, Object target = null, bool canAutoFix = false) {
		Add(new ValidationResult(severity, ruleId, ruleName, message, details, target, canAutoFix));
	}
